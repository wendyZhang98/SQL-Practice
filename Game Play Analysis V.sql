...
who logged in and played a number of games (possibly 0) before logging out on some day using some device.

We define the install date of a player
to be the first login day of that player.
...
for each install date, the number of players that installed the game on that day and the day 1 retention.
...
but didnt log back in on 2017-06-26 so the day 1 retention of 2017-06-25 is 0 / 1 = 0.00


-- Solution: 95%
-- https://leetcode.com/problems/game-play-analysis-v/discuss/320988/Intuitive-MySQL-answer
