...
-- Solution: 5%
-- https://leetcode.com/problems/last-person-to-fit-in-the-bus/discuss/389961/MySQL-beat-100-lol.-Of-course-since-I'm-the-first-one-to-do-this-problem.
...
-- Solution: 22%
-- https://leetcode.com/problems/last-person-to-fit-in-the-bus/discuss/390243/Simple-MySQL-solution-beat-100
...
-- Solution: 93%
-- https://leetcode.com/problems/last-person-to-fit-in-the-bus/discuss/642795/MySql-beat-95-Fast-solution-using-window-function
select person_name from
(select person_name, weight, turn, sum(weight) over(order by turn) as cum_sum from queue) x
where cum_sum <= 1000
