...
-- Solution: 5%
-- https://leetcode.com/problems/immediate-food-delivery-i/discuss/370624/clean-mysql-1-liner-without-case-statement
...
-- Solution: 80%
-- https://leetcode.com/problems/immediate-food-delivery-i/discuss/417926/MySQL-simple-solution
SELECT ROUND(100 * AVG(order_date=customer_pref_delivery_date), 2) AS immediate_percentage
FROM Delivery;


-- Solution: 50%
-- https://leetcode.com/problems/immediate-food-delivery-i/discuss/542399/Easy-to-UnderStand-or-Faster-than-80-or-MySQL-Solution
select
    round(
