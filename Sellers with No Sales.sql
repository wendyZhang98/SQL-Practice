...
-- Solution: 10%
-- https://leetcode.com/problems/sellers-with-no-sales/discuss/877432/intuitive-solution
SELECT seller_name
FROM Seller
...
-- Solution: 10%
-- https://leetcode.com/problems/sellers-with-no-sales/discuss/881022/2-simple-MySQL-solutions
select seller_name
from seller
where seller_id not in (
    select seller_id
