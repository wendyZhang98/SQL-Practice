...
in case of a tie by the customer_id in ascending order.
...
-- ### Solution: 20%
-- https://leetcode.com/submissions/detail/551210602/

with rk as
(
select order_id, order_date, customer_id, cost,
...
from rk r join customers c on r.customer_id = c.customer_id
where rank_ <= 3
order by 1,2,4 desc;
