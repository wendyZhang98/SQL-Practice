...
The sessions we want to count for a user are those
with at least one activity in that time period.
...
| 1.33                      |
+---------------------------+
User 1 and 2 each had 1 session in the past 30 days
while user 3 had 2 sessions so the average is (1 + 1 + 2) / 3 = 1.33.


-- Solution: 60%
-- https://leetcode.com/problems/user-activity-for-the-past-30-days-ii/discuss/361968/MYSQL-Simple-and-readable-no-Subqueries
