...
If the preferred delivery date of the customer is
the same as the order date then the order is called immediate otherwise its called scheduled.
...
-- Solutioin: 84.95%
-- https://leetcode.com/problems/immediate-food-delivery-ii/discuss/370224/MySQL-solution
SELECT
    ROUND(100 * SUM(
