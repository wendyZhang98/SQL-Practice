...
the ID of the user who received the request, and the date of the request.
...
and there are 5 requests in total.
So the rate is 0.80.


### Solution:
# https://leetcode.com/problems/friend-requests-i-overall-acceptance-rate/solution/
SELECT
ROUND(
    IFNULL(
