...
-- Solution: 97.37%
-- https://leetcode.com/problems/user-activity-for-the-past-30-days-i/discuss/351500/easy-to-understand-MySQL-solution-beats-99.17
SELECT activity_date AS day, COUNT(DISTINCT user_id) AS active_users
FROM Activity
GROUP BY activity_date
HAVING activity_date <= '2019-07-27' AND activity_date > SUBDATE('2019-07-27', 30);


-- w3schools.com/sql/sql_ref_keywords.asp
-- ADDDATE()
-- SUBDATE()
-- DATEDIFF()
